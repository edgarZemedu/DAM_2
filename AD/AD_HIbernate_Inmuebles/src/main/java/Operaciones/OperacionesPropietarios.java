 ...
 * @author Fran
 */
public class OperacionesPropietarios {
    ...
    private static void manejaExcepcion(HibernateException he) {
        transa.rollback();
        throw new HibernateException("Ha sucedido un error en la capa de acceso a datos -> "+he.getMessage(), he);
    }
     ...
     *
     * @param propietario Propietarios, elemento a sinertar en la BD
     * @return
     */
    public static long guardaPropietario(Propietario propietario) {
        int id = -1;
        try {
            ...
            id = (int) sesion.save(propietario);
            transa.commit();
     ...
     */
    public static boolean actualizaPropietario(Propietario propietario) {
     ...
     * @throws HibernateException
     */
    public static boolean eliminaPropietario(int id) {
        ...
        try {
            ...
            Propietario propietario_get = sesion.get(Propietario.class, id);
     ...
     * @throws HibernateException
     */
    public static Propietario obtenPropietario(int id) {
        ...
        try {
            ...
            propietario = sesion.get(Propietario.class, id);
            transa.commit();
        } catch (HibernateException he) {
            manejaExcepcion(he);
        } finally {
     ...
     * @throws HibernateException
     */
    public static List<Propietario> obtenListaPropietarios() {
    ...
    public static long guardaDatosBancarios(DatosBancarios datosBancarios) {
        ...
        try {
            ...
            /*guarda el contacto en la base de datos y devuelve el id generado
            aquí no se usa, pero se podría utilizar*/
            id = (int) sesion.save(datosBancarios);
            transa.commit();
        } catch (HibernateException he) {
            manejaExcepcion(he);
        } finally {
    ...
    public static List<Object[]> obtenPropietarioCuentaBancaria(int id) {
